          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {stats.map((stat, idx) => (
              <div key={idx} className="text-center p-6 bg-background rounded-lg border border-border-color">
                <div className="text-base md:text-base font-bold text-accent mb-2">{stat.amount}</div>
      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h3 className="text-base font-bold text-white mb-4">Core Engineering Expertise</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="flex gap-6 p-6 rounded-xl bg-black border border-border-color hover:border-primary/50 transition-colors">
              ...
              <div>
                <h4 className="text-base font-bold text-white mb-2">Platform Migration</h4>
            ...
            <div className="flex gap-6 p-6 rounded-xl bg-black border border-border-color hover:border-primary/50 transition-colors">
              ...
              <div>
                <h4 className="text-base font-bold text-white mb-2">Custom Headless Solutions</h4>
            ...
            <div className="flex gap-6 p-6 rounded-xl bg-black border border-border-color hover:border-primary/50 transition-colors">
              ...
              <div>
                <h4 className="text-base font-bold text-white mb-2">API & ERP Integrations</h4>
            ...
            <div className="flex gap-6 p-6 rounded-xl bg-black border border-border-color hover:border-primary/50 transition-colors">
              ...
              <div>
                <h4 className="text-base font-bold text-white mb-2">Performance & CRO Auditing</h4>
